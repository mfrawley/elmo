...
Elm.CallToAction = Elm.CallToAction || {};
Elm.CallToAction.make = function (_elm) {
   "use strict";
   _elm.CallToAction = _elm.CallToAction || {};
   if (_elm.CallToAction.values)
   return _elm.CallToAction.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   title) {
      ...
      _L.fromArray([$Html$Attributes.type$("text")
                   ...
                   ,$Html$Attributes.placeholder("Enter your button title here")
                   ,$Html$Attributes.value(title)
                   ,A3($Html$Events.on,
                   "input",
                   $Html$Events.targetValue,
                   function ($) {
                      return $Signal.message(address)(UpdateTitle($));
                   })]),
      _L.fromArray([]));
   });
   ...
   var buttonStyleToString = function (bStyle) {
      return function () {
         switch (bStyle)
         {case 1: return "1";
            case 2: return "2";
   ...
   var preview = function (model) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.id("module-preview")]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("jtpl-main jtpl-section cc-content-parent")]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.id("cc-m-10813654799")
                   ,$Html$Attributes.$class("j-module n j-callToAction ")]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class(A2($Basics._op["++"],
      "j-calltoaction-wrapper j-calltoaction-align-",
      $Basics.toString(model.buttonAlign)))]),
      _L.fromArray([A2($Html.a,
      _L.fromArray([$Html$Attributes.$class(A2($Basics._op["++"],
                   "j-calltoaction-link j-calltoaction-link-style-",
                   buttonStyleToString(model.buttonStyle)))
                   ,$Html$Attributes.href(model.buttonHref)]),
   ...
   var main = $StartApp$Simple.start({_: {}
                                     ...
                                     ,update: update
                                     ,view: view});
   var Style3 = {ctor: "Style3"};
   var Style2 = {ctor: "Style2"};
   var Style1 = {ctor: "Style1"};
   _elm.CallToAction.values = {_op: _op
                              ,Style1: Style1
                              ,Style2: Style2
                              ,Style3: Style3
                              ,buttonStyleToString: buttonStyleToString
